...
export const site = {
  ...
  location: {
    ...
    /** Set once the business confirms the exact pin. */
    mapUrl: null as string | null,
    /** Approximate coordinates for schema.org — replace with the confirmed ones. */
    latitude: 4.8368,
    longitude: -75.6774,
  },
...
export const whatsappMessages = {
  ...
  celebration: 'Hola, quiero preparar una sorpresa en Glamping Cumbre de los Molinos. ¿Qué opciones de decoración tienen?',
